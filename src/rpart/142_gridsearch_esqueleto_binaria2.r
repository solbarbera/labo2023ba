...
PARAM$semillas <- c(100129, 100151, 500009, 903983, 701819) # Semillas mias
...
setwd("C:/Users/Sol Barbera/Documents/Lab1") # Establezco el Working Directory
# cargo los datos
...
# modifico la clase
dataset <- dataset[, clase_binaria1 := ifelse(clase_ternaria %in% c("BAJA+1", "CONTINUA"), "neg", "pos")]
